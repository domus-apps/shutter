...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Shutter v$VERSION</title>
      <link>https://github.com/domus-apps/shutter/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/shutter/releases/download/v$VERSION/Shutter.zip"
        $SIGNATURE_ATTRS
